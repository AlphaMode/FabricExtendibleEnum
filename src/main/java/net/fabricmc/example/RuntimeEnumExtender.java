...
public class RuntimeEnumExtender {
    ...
    private final Type MARKER_IFACE = Type.getType("Lnet/fabric/example/IExtensibleEnum;");
    ...
    //@Override
    public int processClassWithFlags(boolean pre, final ClassNode classNode, final Type classType)
    {
